...
public class Camera : MonoBehaviour
{
    ...
    void Update()
    {
        float speed = GameObject.Find("Car").GetComponent<Drive>().getSpeed;
        ...
        float turning = Input.GetAxis("Horizontal") * Time.deltaTime * GameObject.Find("Car").GetComponent<Drive>().getRotateSpeed;
        float savedTime = 0;
